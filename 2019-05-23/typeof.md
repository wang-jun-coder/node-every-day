...
// 注意: instanceof 右边必须是一个对象，instanceof 判断的是左表达式原型链中是否存在有右表达式的构造函数
	```
...
### 假值
	...
	const n2 = null == undefined;	// true  	null == undefined is true 
	...
	```
注意：null == undefined is true 是 ecma 的规范：https://www.ecma-international.org/ecma-262/5.1/#sec-11.9.3
